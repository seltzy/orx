...
static orxINLINE void orxRender_Home_RenderFPS()
{
  ...
  if(pstFont != orxNULL)
  {
    ...
    /* Displays it */
    orxDisplay_TransformText(acBuffer, orxNULL, pstBitmap, orxFont_GetMap(pstFont), &stTextTransform, orxDISPLAY_SMOOTHING_OFF, orxDISPLAY_BLEND_MODE_ALPHA);
  }
...
static orxINLINE void orxRender_Home_RenderProfiler()
{
  ...
  orxDisplay_TransformText(acLabel, orxNULL, pstFontBitmap, pstMap, &stTransform, orxDISPLAY_SMOOTHING_NONE, orxDISPLAY_BLEND_MODE_ALPHA);
      ...
      s32MarkerID = orxProfiler_GetNextSortedMarkerID(s32MarkerID))
  {
    ...
    && (orxProfiler_GetMarkerPushCounter(s32MarkerID) > 0))
    {
      ...
      orxDisplay_TransformText(acLabel, orxNULL, pstFontBitmap, orxFont_GetMap(pstFont), &stTransform, orxDISPLAY_SMOOTHING_NONE, orxDISPLAY_BLEND_MODE_ALPHA);
...
static orxINLINE void orxRender_Home_RenderConsole()
{
  ...
  if((u32CursorIndex < 255) && (orxFLAG_TEST(sstRender.u32Flags, orxRENDER_KU32_STATIC_FLAG_CONSOLE_BLINK)))
  {
    ...
    if(orxConsole_IsInsertMode() != orxFALSE)
    {
      ...
      orxDisplay_TransformText(zText, orxNULL, pstFontBitmap, pstMap, &stTransform, orxDISPLAY_SMOOTHING_NONE, orxDISPLAY_BLEND_MODE_ALPHA);
  ...
  if(u32Offset != 0)
  {
    ...
    orxDisplay_TransformText(acBuffer, orxNULL, pstFontBitmap, pstMap, &stTransform, orxDISPLAY_SMOOTHING_NONE, orxDISPLAY_BLEND_MODE_ALPHA);
  ...
  && (orxStructure_TestFlags(pstGraphic, orxGRAPHIC_KU32_FLAG_2D | orxGRAPHIC_KU32_FLAG_TEXT)))
  {
    ...
    if((orxEvent_Send(&stEvent) != orxSTATUS_FAILURE) && (pstBitmap != orxNULL))
    {
      ...
      if((stPayload.stObject.pstTransform->fScaleX != orxFLOAT_0) && (stPayload.stObject.pstTransform->fScaleY != orxFLOAT_0))
      {
        ...
        {
          /* Transfomrs text */
          eResult = orxDisplay_TransformText(orxText_GetString(pstText), orxText_GetMarkerIterator(pstText), pstBitmap, orxFont_GetMap(pstFont), stPayload.stObject.pstTransform, _eSmoothing, _eBlendMode);
        }
      }
      else
      {
